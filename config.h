 ...
 */
static int workspaces_per_mon = 1;
...
static Rule clientrules[] = {
	...
	{ .class = "Gimp", .flags = Floating|SwitchWorkspace },
	...
	{ .class = "File-roller", .flags = Centered|Floating|SwitchWorkspace|RevertWorkspace },
	...
	{ .class = "com.github.th_ch.youtube_music", .workspace = "10" },  // catch first before role rules
	{ .class = "Telegram", .workspace = "5", .flags = SwitchWorkspace },
	{ .class = "discord", .workspace = "5", .flags = SwitchWorkspace },
	{ .class = "vesktop", .workspace = "5", .flags = SwitchWorkspace },
	{ .class = "steam", .workspace = "6", .flags = Centered },
	{ .class = "steam_app_", .flags = SteamGame|Centered },
	...
	// { .class = "steam", .instance = "steamwebhelper", .title = "Friends List", .workspace = "6", .resume = 0 }
};
...
static WorkspaceRule wsrules[] = {
	...
	{  "15",   2,       1,       0,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "1",   "",   "[1]", },
	{  "16",   2,       1,       0,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "2",   "",   "[2]", },
	{  "17",   2,       1,       0,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "3",   "",   "[3]", },
	{  "18",   2,       1,       0,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "4",   "",   "[4]", },
	{  "19",   2,       1,       0,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "5",   "",   "[5]", },
};
...
static const char *web_browser[] = {NULL, "librewolf", NULL };
...
static const char *volumeup[] = { NULL, "playerctl", "-p", "YoutubeMusic", "volume", "0.01+", NULL };
static const char *volumedown[] = { NULL, "playerctl", "-p", "YoutubeMusic", "volume", "0.01-", NULL };
static const char *playernext[] = { NULL, "playerctl", "-p", "YoutubeMusic", "next", NULL };
static const char *playerprevious[] = { NULL, "playerctl", "-p", "YoutubeMusic", "previous", NULL };
static const char *playerplay[] = { NULL, "playerctl", "-p", "YoutubeMusic", "play-pause", NULL };
...
static Key keys[] = {
	...
	{ KeyPress,   Alt,                          XK_space,        spawn,                  {.v = roficmd } }, // spawn dmenu for launching other programs
	...
	{ KeyPress,   Ctrl|Shift,                   XK_Up,           spawn,                  {.v = volumeup } }, //
	{ KeyPress,   Ctrl|Shift,                   XK_Down,         spawn,                  {.v = volumedown } }, //
	{ KeyPress,   Ctrl|Shift,                   XK_Right,        spawn,                  {.v = playernext } }, //
	{ KeyPress,   Ctrl|Shift,                   XK_Left,         spawn,                  {.v = playerprevious } }, //
	{ KeyPress,   Ctrl|Shift,                   XK_space,        spawn,                  {.v = playerplay } }, //
